                    ...
                    <div class="col-lg-3">
                         <div class="card card-pricing">
                              <div class="card-body">
                                   ...
                                   <h2 class="mt-0 mb-3 fw-bold">KES 500 <span class="fs-14 fw-medium text-muted">/
                                             Month</span></h2>
                                   <ul
                    ...
                    <div class="col-lg-3">
                         <div class="card card-pricing">
                              <div class="card-body">
                                   ...
                                   <h2 class="mt-0 mb-3 fw-bold">KES 1,500 <span class="fs-14 fw-medium text-muted">/
                                             Month</span></h2>
                                   <ul
                                        class="card-pricing-features text-muted border-top pt-2 mt-2 ps-0 list-unstyled">
                                        <li class="text-dark"><i class="text-primary fs-15 me-1"
                    ...
                    <div class="col-lg-3">
                         <div class="card card-pricing">
                              <div class="card-body">
                                   ...
                                   <h2 class="mt-0 mb-3 fw-bold">KES 3,000 <span class="fs-14 fw-medium text-muted">/
                                             Month</span></h2>
                                   <ul
                                        class="card-pricing-features text-muted border-top pt-2 mt-2 ps-0 list-unstyled">
                                        <li class="text-dark"><i class="text-primary fs-15 me-1"
                    ...
                    <div class="col-lg-3">
                         <div class="card card-pricing">
                              <div class="card-body">
                                   ...
                                   <h2 class="mt-0 mb-3 fw-bold">KES 5,000 <span class="fs-14 fw-medium text-muted">/
                                             Month</span></h2>
                                   <ul
                                        class="card-pricing-features text-muted border-top pt-2 mt-2 ps-0 list-unstyled">
                                        <li class="text-dark"><i class="text-primary fs-15 me-1"
