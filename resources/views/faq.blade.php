                        ...
                        <div class="row text-center">
                            <div class="col-lg-12">
                                <div class="border p-3 rounded bg-light-subtle">
                                    ...
                                    <p class="mb-0">If you have a Hydrasoft Technologies. account and can't log in, try to reset your
                                ...
                                <div class="border p-3 rounded bg-light-subtle">
                                    ...
                                    <p class="mb-0">You can use Hydrasoft Technologies. to stay connected on many devices including
