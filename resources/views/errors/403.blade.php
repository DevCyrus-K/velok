@extends('layouts.auth', ['title' => '403 - Forbidden'])
                            ...
                            <div class="col">
                                <div class="p-4">
                                    <div class="mx-auto mb-4 text-center">
                                        ...
                                        <div class="mt-5 mb-3 text-warning">
                                            <i data-lucide="lock" style="width: 100px; height: 100px;"></i>
                                        </div>
                                        <h2 class="fs-22 lh-base fw-bold">Access Forbidden</h2>
                                        <p class="text-muted mt-1 mb-4">You don't have permission to access this resource. <br /> Please contact an administrator if you believe this is a mistake.</p>
